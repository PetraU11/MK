...
email.addEventListener("click", () => {
    ...
    emailShown.classList.remove("header__icons-emailAddressHidden")
    emailShown.classList.add("header__icons-emailAddressShown")
})
...
phone.addEventListener("click", () => {
    ...
    phoneShown.classList.remove("header__icons-phoneNumberHidden")
    phoneShown.classList.add("header__icons-phoneNumberShown")
})
